...
class ScienceFragment : Fragment(), OnItemClickListener {
    ...
    private lateinit var adapterScienceTop: CustomNewsAdapter
    private lateinit var adapterLatestScience: LatestTechAdapter
    ...
    private fun setResponseInUI(list: ArrayList<Collection>) {
        binding.rvScienceTop.layoutManager =
            WrapContentStaggeredGridLayoutManager(1, LinearLayoutManager.VERTICAL)
        adapterScienceTop = CustomNewsAdapter(this@ScienceFragment, list, this)
        binding.rvScienceTop.adapter = adapterScienceTop
        binding.rvLatestScience.layoutManager =
            WrapContentStaggeredGridLayoutManager(1, LinearLayoutManager.VERTICAL)
        adapterLatestScience = LatestTechAdapter(this@ScienceFragment, list, this)
        binding.rvLatestScience.adapter = adapterLatestScience
    }
